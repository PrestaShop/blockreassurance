    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 position-hook">
        <label class="col-lg-3 col-lg-offset-1 col-xs-3 col-xs-offset-1">
            <div class="help-block customradiodesign">
                ...
                />
                <label for="PSR_HOOK_HEADER"><span><span></span></span>{l s='Above header' mod='psreassurance'}
                </label><br/><br/>
        ...
        <label class="col-lg-3 col-lg-offset-1 col-xs-3 col-xs-offset-1">
            <div class="help-block customradiodesign">
                ...
                />
                <label for="PSR_HOOK_HEADER_0"><span><span></span></span>{l s='Below header' mod='psreassurance'}
                </label><br/><br/>
        ...
        <label class="col-lg-3 col-lg-offset-1 col-xs-3 col-xs-offset-1">
            <div class="help-block customradiodesign">
                ...
                />
                <label for="PSR_HOOK_HEADER_1"><span><span></span></span>{l s='None' mod='psreassurance'}
                </label><br/><br/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 position-hook">
        <label class="col-lg-3 col-lg-offset-1 col-xs-3 col-xs-offset-1">
            <div class="help-block customradiodesign">
                ...
                />
                <label for="PSR_HOOK_FOOTER"><span><span></span></span>{l s='Above footer' mod='psreassurance'}
                </label><br/><br/>
        ...
        <label class="col-lg-3 col-lg-offset-1 col-xs-3 col-xs-offset-1">
            <div class="help-block customradiodesign">
                ...
                />
                <label for="PSR_HOOK_FOOTER_0"><span><span></span></span>{l s='Below footer' mod='psreassurance'}
                </label><br/><br/>
        ...
        <label class="col-lg-3 col-lg-offset-1 col-xs-3 col-xs-offset-1">
            <div class="help-block customradiodesign">
                ...
                />
                <label for="PSR_HOOK_FOOTER_1"><span><span></span></span>{l s='None' mod='psreassurance'}
                </label><br/><br/>
                <img src="{$img_path}allpage_none.jpg" width="150" height="150">
            </div>
        </label>
